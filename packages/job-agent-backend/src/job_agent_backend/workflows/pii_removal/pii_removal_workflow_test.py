...
class TestCreatePiiRemovalWorkflow:
    ...
    def test_create_pii_removal_workflow_returns_compiled_state_graph(self):
    ...
    def test_create_pii_removal_workflow_has_correct_name(self):
        """Test that workflow has the expected name."""
        workflow = create_pii_removal_workflow()

        assert workflow.name == "PIIRemovalWorkflow"

    def test_create_pii_removal_workflow_has_remove_pii_node(self):
    ...
    def test_create_pii_removal_workflow_has_correct_entry_point(self):
    ...
    def test_create_pii_removal_workflow_remove_pii_leads_to_end(self):
