...
class TestAnonymizeText:
    ...
    def test_anonymize_text_returns_cleaned_content(self):
        ...
        anonymize_text = create_anonymize_text(mock_factory)

        result = anonymize_text("Original CV with PII")

        assert result == "Cleaned CV without PII"
        mock_factory.get_model.assert_called_once_with(model_id="pii-removal")
        mock_model.invoke.assert_called_once()

    def test_anonymize_text_strips_whitespace(self):
    ...
    def test_anonymize_text_raises_runtime_error_on_model_failure(self):
    ...
    def test_anonymize_text_handles_response_without_content_attribute(self):
    ...
    def test_anonymize_text_raises_runtime_error_on_empty_result(self):
