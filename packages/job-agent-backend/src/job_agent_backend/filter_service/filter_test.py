...
class TestFilterService:
    ...
    def _apply_filter(self, jobs: List[Any], config: Optional[FilterConfig]) -> List[JobDict]:
        """Helper to apply filter with loose input typing for test convenience."""
        service = FilterService()
        service.configure(config)
        return service.filter(cast(List[JobDict], jobs))

    def test_filter_with_no_config_returns_all_jobs(self, sample_jobs_list) -> None:
    ...
    def test_filter_with_empty_config_returns_all_jobs(self, sample_jobs_list) -> None:
        """Test that filtering with empty config returns all jobs."""
        result = self._apply_filter(sample_jobs_list, {})
        assert len(result) == len(sample_jobs_list)
        assert result == sample_jobs_list

    def test_filter_by_max_experience_months(self, sample_jobs_list) -> None:
    ...
    def test_filter_by_max_experience_excludes_higher(self, sample_jobs_list) -> None:
    ...
    def test_filter_by_location_allows_to_apply(self, sample_jobs_list) -> None:
    ...
    def test_filter_by_multiple_criteria(self, sample_jobs_list) -> None:
    ...
    def test_filter_very_strict_criteria_returns_few_jobs(self, sample_jobs_list) -> None:
    ...
    def test_filter_impossible_criteria_returns_empty_list(self, sample_jobs_list) -> None:
    ...
    def test_filter_with_missing_location_data(self) -> None:
    ...
    def test_filter_with_missing_experience_data(self) -> None:
    ...
    def test_filter_location_allows_false_keeps_jobs_when_not_required(
    ...
    def test_filter_preserves_job_data_structure(self, sample_jobs_list) -> None:
    ...
    def test_filter_with_edge_case_experience_values(self) -> None:
    ...
    def test_filter_with_realistic_job_data(self, sample_job_dict) -> None:
    ...
    def test_filter_excludes_jobs_present_in_repository(self, stub_job_repository_factory) -> None:
        ...
        result = service.filter(cast(List[JobDict], jobs))

        assert len(result) == 1
        assert result[0]["job_id"] == 50

    def test_constructor_applies_default_config(self) -> None:
    ...
    def test_filter_raises_when_repository_factory_throws(self) -> None:
        ...
        with pytest.raises(RuntimeError, match="Factory failure"):
            service.filter(cast(List[JobDict], jobs))

    def test_filter_raises_when_get_by_external_id_throws(
        self, failing_job_repository_factory
    ) -> None:
    ...
    def test_filter_raises_when_has_active_job_throws(self, failing_job_repository_factory) -> None:
    ...
    def test_filter_raises_when_experience_months_is_none(self) -> None:
    ...
    def test_filter_raises_when_location_is_none(self) -> None:
    ...
    def test_filter_excludes_previously_stored_irrelevant_jobs(
...
class TestFilterServiceWithRejected:
    ...
    def test_filter_with_rejected_returns_tuple_of_two_lists(self, sample_jobs_list) -> None:
    ...
    def test_filter_with_rejected_experience_check_populates_rejected(
        self, sample_jobs_list
    ) -> None:
    ...
    def test_filter_with_rejected_location_check_populates_rejected(self, sample_jobs_list) -> None:
    ...
    def test_filter_with_rejected_both_criteria_populates_rejected(self, sample_jobs_list) -> None:
    ...
    def test_filter_with_rejected_preserves_job_data_structure(self, sample_jobs_list) -> None:
    ...
    def test_filter_with_rejected_sum_equals_input(self, sample_jobs_list) -> None:
    ...
    def test_filter_with_rejected_empty_input_returns_empty_lists(self) -> None:
    ...
    def test_filter_with_rejected_no_rejections(self) -> None:
        ...
        passed, rejected = service.filter_with_rejected(cast(List[JobDict], jobs))

        assert len(passed) == 2
        assert len(rejected) == 0

    def test_filter_with_rejected_all_rejected(self) -> None:
