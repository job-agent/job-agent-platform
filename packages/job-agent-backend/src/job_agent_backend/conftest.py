"""Shared test fixtures for job_agent_backend package tests.

These fixtures are available to all tests in the job_agent_backend package
and its subpackages (core, filter_service, workflows, etc.).
"""
